...
// checks if the DeploymentProfileSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentProfileSummary{}

// DeploymentProfileSummary struct for DeploymentProfileSummary
type DeploymentProfileSummary struct {
...
type _DeploymentProfileSummary DeploymentProfileSummary
...
func (o *DeploymentProfileSummary) SetMaximumCapacityNil() {
...
func (o *DeploymentProfileSummary) SetBufferValueMinNil() {
...
func (o *DeploymentProfileSummary) SetBufferValueMaxNil() {
...
func (o DeploymentProfileSummary) MarshalJSON() ([]byte, error) {
...
func (o DeploymentProfileSummary) ToMap() (map[string]interface{}, error) {
...
func (o *DeploymentProfileSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentProfileSummary := _DeploymentProfileSummary{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeploymentProfileSummary)

	if err != nil {
		return err
	}

	*o = DeploymentProfileSummary(varDeploymentProfileSummary)

	return err
}

type NullableDeploymentProfileSummary struct {
	value *DeploymentProfileSummary
	isSet bool
}

func (v NullableDeploymentProfileSummary) Get() *DeploymentProfileSummary {
	return v.value
}

func (v *NullableDeploymentProfileSummary) Set(val *DeploymentProfileSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentProfileSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentProfileSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentProfileSummary(val *DeploymentProfileSummary) *NullableDeploymentProfileSummary {
	return &NullableDeploymentProfileSummary{value: val, isSet: true}
}

func (v NullableDeploymentProfileSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentProfileSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
