...
type Label struct {
	// Label key, only hyphens (-), underscores (_), lowercase characters and numbers are allowed. Keys must start with a lowercase character.
	Key string `json:"key"`
	// Label value, maximum length is 150 characters
