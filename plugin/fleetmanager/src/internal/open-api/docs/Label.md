...
------------ | ------------- | ------------- | -------------
**Key** | **string** | Label key, only hyphens (-), underscores (_), lowercase characters and numbers are allowed. Keys must start with a lowercase character. | 
**Value** | **string** | Label value, maximum length is 150 characters | 
